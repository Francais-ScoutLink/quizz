...
set info {
    "Merci de respecter le fait que ce canal parle uniquement Français | Thank you to respect the fact that this channel only speaks French"
}
...
set infonotice "Pour joue taper !quizz"
